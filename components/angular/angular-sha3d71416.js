/**
 * @license AngularJS v1.3.6-local+sha.3d71416
...
function minErr(module, ErrorConstructor) {
  ...
  return function() {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.6-local+sha.3d71416/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.6-local+sha.3d71416',    // all of these placeholder strings will be replaced by grunt's
